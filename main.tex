...
\exercise Viết chương trình sao chép dữ liệu từ địa chỉ $70H$ trong RAM sang các địa chỉ từ $30H$ đến $35H$. Chương trình không được sử dụng nhiều hơn $10$ chu kì máy.
...
\begin{verbatim}
    ...
    MOV 35H, A
\end{verbatim}
Mỗi lệnh chỉ mất $1$ chu kì máy, nên tổng cộng chương trình này mất $7$ chu kì máy theo yêu cầu đề bài.
